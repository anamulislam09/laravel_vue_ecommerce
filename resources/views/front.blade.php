    ...
    <header id="header">
        <div class="container">
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    <!-- Logo -->
                    <a class="logo" href="#"><img src="/front_assets/images/logo.png" alt="logo"></a>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="caption-img text-right">
                        <img src="/front_assets/images/watch-7.png" class="img-fluid animation-jump" alt>
                    </div>
                </div>
                <!--end caption image-->
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="about-img text-center">
                        <img src="/front_assets/images/watch-8.png" class="img-fluid animation-jump" alt="Image">
                    </div>
                </div>
                <!--end about image-->
                <!--start about info-->
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="product-gallery owl-carousel">
                        <img src="/front_assets/images/watch-14.png" class="img-fluid" alt>
                        <img src="/front_assets/images/watch-15.png" class="img-fluid" alt>
                        <img src="/front_assets/images/watch-12.png" class="img-fluid" alt>
                    </div>
                </div>
                <!--end product gallery-->
        ...
        <div class="container">
            ...
            <div class="testi-carousel owl-carousel">
                ...
                <div class="testi-single text-center">
                    <div class="client-info">
                        <div class="client-img">
                            <img src="/front_assets/images/client-1.jpg" class="img-fluid" alt>
                        </div>
                ...
                <div class="testi-single text-center">
                    <div class="client-info">
                        <div class="client-img">
                            <img src="/front_assets/images/client-2.jpg" class="img-fluid" alt>
                        </div>
                        <div class="client-details">
                            <h4>Andrew Watt</h4>
                ...
                <div class="testi-single text-center">
                    <div class="client-info">
                        <div class="client-img">
                            <img src="/front_assets/images/client-3.jpg" class="img-fluid" alt>
                        </div>
                        <div class="client-details">
                            <h4>Emma Dee</h4>
                            <p>App Developer</p>
                ...
                <div class="testi-single text-center">
                    <div class="client-info">
                        <div class="client-img">
                            <img src="/front_assets/images/client-4.jpg" class="img-fluid" alt>
                        </div>
                        <div class="client-details">
                            <h4>Olivia Smith</h4>
                            <p>Web Developer</p>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="contact-img text-center">
                        <img src="/front_assets/images/watch-10.png" class="img-fluid animation-jump" alt>
                    </div>
                </div>
                <!--end contact image-->
            </div>
